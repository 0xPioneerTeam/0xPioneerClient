...
export enum protobuf_c2s {
    ...
    get_new_battle_report_red_point = 503,
    receive_new_battle_report_reward = 504,
...
export enum protobuf_s2c {
    ...
    // ------ idle task ------
    get_idle_task_list_res = 11801,
    idle_task_change = 11802,
    get_idle_task_red_point_res = 11803,
