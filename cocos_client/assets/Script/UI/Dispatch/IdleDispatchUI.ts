...
@ccclass("IdleDispatchUI")
export class IdleDispatchUI extends ViewController implements CircularListDelegate {
    ...
    private _actionCallback: (confirmed: boolean, actionPioneerUnqueId: string) => void = null;
    ...
    public configuration(
        ...
        actionCallback: (confirmed: boolean, actionPioneerUnqueId: string) => void
    ) {
