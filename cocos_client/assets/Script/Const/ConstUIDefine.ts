export enum UIName {
    LoginUI = "abresources/prefab/ui/LoginUI",
    MainUI = "abresources/prefab/ui/MainUI",

    RookieGuide = "abresources/prefab/ui/RookieGuide",
    RookieStepMaskUI = "abresources/prefab/ui/RookieStepMaskUI",

    DialogueUI = "abresources/prefab/ui/DialogueUI",
    ...
    Backpack = "abresources/prefab/ui/Backpack",
    ItemInfoUI = "abresources/prefab/ui/ItemInfoUI",
    ItemGettedUI = "abresources/prefab/ui/ItemGettedUI",
    ItemSelectFromThreeUI = "abresources/prefab/ui/ItemSelectFromThreeUI",
    BattleReportUI = "abresources/prefab/ui/BattleReportUI",
...
export enum GameName {
    GameMain = "abresources/prefab/game/Game",
}

export enum HUDName {
    CommonTip = "abresources/prefab/hud/HUDView",
